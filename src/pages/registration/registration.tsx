                    ...
                    <form onSubmit={handlePreventDefault} className='registration-form'>
                        <div className='registration-inputs'>
                            <FormInput label='Username'
                             ...
                             type='text'
                             func={(e:React.ChangeEvent<HTMLInputElement >) =>setNewUser((prev) => ({...prev, name:e.target.value}))}
                            />
                            <FormInput label='Email'
                             name='email'
                             placeholder='Enter email'
                             type='text'
                             func={(e:React.ChangeEvent<HTMLInputElement >) =>setNewUser((prev) => ({...prev, email: e.target.value}))}
                            />                           
                        </div>
                       <div className='registration-inputs'>
                            <FormInput label='Password'
                             ...
                             type='password'
                             func={(e:React.ChangeEvent<HTMLInputElement >) =>setNewUser((prev) => ({...prev, password: e.target.value}))}
                            />
                            <FormInput label='Confirm Password'
                             name='c-password'
                             placeholder='Confirm password'
                             type='password'
                             func={(e:React.ChangeEvent<HTMLInputElement >) =>setcPassword(e.target.value)}
                            />
                       </div>
                       <label className='registration-terms'>
                            <input type="checkbox"
                             required
                             checked={checkPolicy}
                             onChange={(e:React.ChangeEvent<HTMLInputElement>) =>setCheckPolicy(e.target.checked)}
                            />
